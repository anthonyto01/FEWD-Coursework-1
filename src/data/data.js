export const recipes = [
    {
        id: "1",
        name: "Sticky soy and ginger pork",
    ...
    {
        id: "2",
        name: "Cookies and cream fudge brownies",
    ...
    {
        id: "3",
        name: "Mango passion with honey and yoghurt",
    ...
    },
    {
        ...
        ingredients: [
            ...
            "200g/7oz frozen sweetcorn",
            "200g tub full-fat cream cheese (also known as soft cheese)",
            "145g tin tuna chunks, any kind, drained",
        ...
        method: [
            ...
            "Half-fill a large saucepan with water, cover with a lid and bring to a boil over high heat. Stir in the pasta and cook uncovered for about 10 minutes, or until the pasta is tender but retains just a little ‘bite’. Stir occasionally as the pasta cooks, so it doesn’t stick.",
            "Add the sweetcorn to the saucepan, cover and return to the boil. Cook for 2 minutes more. Take out a couple of ladles of the water (around 150ml/¼ pint) and put to one side in a bowl.",
            "Drain the pasta and sweetcorn in a colander then return to the pan. Add the tomatoes and the drained tuna and toss together over medium heat for 1–2 minutes or until the tomatoes are beginning to warm.",
            "Pour the reserved water over the pasta, add the soft cheese and stir well over low heat until the cheese melts and coats the pasta. Season with freshly ground black pepper and serve immediately."

        ],
    },
    {
        id: "7",
        name: "Braised beef in red wine",
    ...
    },
    {
        ...
        ingredients: [
            ...
            "1 slice bread, blended into breadcrumbs (or 5 tbsp dried breadcrumbs)",
            "large handful fresh parsley",
            "5 hard-boiled eggs (boiled for 8 minutes, then plunged into cold water), peeled",
            "500g/1lb 2oz ready-rolled puff pastry",
            "3 tsp yeast extract, mixed with 1 teaspoon warm water",
